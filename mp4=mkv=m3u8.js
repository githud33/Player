// ==========================================
// ✅แก้ไขสมบูรณ์แล้ว✔MP4-MKV-M3U8  ตัว👉(V02.เปรี่ยนส่วนหัวเรื่องการจำเวลาไว้ใช้สำหรับMP4.js)
...
document.addEventListener("DOMContentLoaded", async function () {
    ...
    var defaultOptions = {
        ...
        settings: ['quality', 'audioTrack', 'captions', 'speed', 'loop'],
...
ถ้าอยากให้พื้นที่ลากเสียงกว้างขึ้น: เปลี่ยนเลข 0.7 เป็น 0.5 ในส่วนของ isRightSide
   ...
   ==========================================================  */
// ==========================================
// ✅แก้ไขสมบูรณ์แล้ว✔MP4-MKV-M3U8  ตัว👉(V01.เปรี่ยนส่วนหัวเรื่องการจำเวลาไว้ใช้สำหรับMP4.js)
//  https://github.com/githud33/copy/blob/main/videoโค้ดหลักใช้งาน
// เหมือนกับตัว เครื่องเล่น-js-m3u8.js ที่ใช้อยู่ ไว้สำหรับให้ดาวน์โหลด MP4 หรือเปิด MP4
// ==========================================
