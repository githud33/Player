<script>
    ...
    document.addEventListener("DOMContentLoaded", async function () {
        ...
        var defaultOptions = {
            ...
            i18n: {
                restart: 'รีสตาร์ท', play: 'เล่น', pause: 'หยุดชั่วคราว',
                currentTime: 'เวลาปัจจุบัน', duration: 'ระยะเวลา', volume: 'ความดังเสียง',
                mute: 'ปิดเสียง', unmute: 'เปิดเสียง', settings: 'การตั้งค่า',
                speed: 'ความเร็ว', normal: 'ปกติ', quality: 'คุณภาพ', loop: 'ลูป',
                qualityBadge: { 2160: '4K', 1440: 'HD', 1080: 'HD', 720: 'HD', 480: 'SD' }
            },
        ...
        if (isHlsSupported) {
            ...
            if (isMaintenanceMode) {
                ...
                if (allSources.length === 1) {
                    ...
                    // ปั๊มแท็กที่สองโดยใช้เลขพิเศษ '9999' เพื่อเปิดทางให้ระบบ Plyr ยอมสร้างเมนู
                    ...
                    // 🔥 ฉีดโค้ด CSS สั่งลบปุ่ม '9999' ออกไปจากหน้าจอทันที สมาชิกจะไม่มีวันเห็นเลขนี้
                    ...
                    // ล็อกตัวเลือกให้แสดงเฉพาะค่าจริงของพี่ และมีค่าหลอกแฝงอยู่เบื้องหลัง
                    defaultOptions.quality = {
                        default: userSize,       // บังคับเลือกตัวเลขจริงของพี่เป็นค่าเริ่มต้น (เช่น 1080p)
                        options: [userSize, 9999] // ยัดสองค่าเพื่อให้ผ่านเงื่อนไข Plyr
                    };
                } 
                ...
                // 3. กรณีมีหลายแท็กอยู่แล้ว (เช่น พี่จงใจแยกไฟล์ 480, 720, 1080 จริงๆ) ให้รันปกติ
                    ...
                    allSources.forEach(function(el) { el.src = source; });
