<script>
    ...
    document.addEventListener("DOMContentLoaded", async function () {
        ...
        var defaultOptions = {
            ...
            // ปุ่มกด 10 วินาทีของพี่ที่จัดวางตำแหน่งเรียบร้อยแล้ว อยู่ครบตรงนี้ครับ
            controls: [
        ...
        if (isHlsSupported) {
            // 🟢 โค้ดเดิมของพี่ เพิ่มเติมคือใส่คำสั่งกันจิ้มเด้ง (maxSeekHole) เผื่อไว้ตอนเล่นไฟล์ .m3u8 ครับ
            var hlsConfig = {
                debug: false, 
                ...
                // 🛠️ หยอด 3 บรรทัดนี้เพิ่มเข้าไปในคอนฟิกของพี่ เพื่อซ่อมเวลาตอนจิ้มสำหรับไฟล์สตรีมมิ่งครับ
                maxSeekHole: 3,          
                nudgeMaxRetries: 10,     
                nudgeOffset: 0.1
            };
            ...
            // 🟢 ฝั่งนี้ทำหน้าที่เล่นไฟล์เดี่ยว MP4 / MKV หรือวิดีโอตอนปิดระบบ (Maintenance Mode)
            if (sourceElement) {
